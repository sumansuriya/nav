...
export const EmployeeAdd = () => {
  ...
  <Nav.Link onClick={signOut}>Sign Out</Nav.Link>
      ...
      {state.employee.progress && (
        ...
        <div className="mx-4 alert alert-success w-50 ">Employee added Successfully</div>
        </div>
      )}

      <form
        ref={formEl}
        className="mx-4 needs-validation"
        noValidate
      >
        <div className="row mb-1 justify-content-center">
         <input
        ...
        <h5 className="text-light text-center"> Enter DOB </h5>
        <div className="row mb-1 justify-content-center">
          <input
            type="date"
            className="form-control form-control-lg w-50"
...
<h5 className="text-light text-center"> Enter HireDate </h5>
        <div className="row mb-1 justify-content-center">
          <input
