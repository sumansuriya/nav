...
import {createEmployeeLeaveRequestAction,
       } from "../redux/EmployeeLeaveRequestReducer";
  import {updateEmployeeLeaveRequestAction,
  } from "../redux/EmployeeLeaveRequestReducer";
  ...
  return (
    ...
    <div className="alert alert-secondary">
      ...
      {state.employeeLeaveRequest.progress && (
        ...
        <div className="mx-4 alert alert-success w-50">Leave Request added Successfully</div>
        </div>
      )}
